...
import { useLaunchLocationPrompt } from '../../hooks/useLaunchLocationPrompt';
...
export function RootNavigator() {
  ...
  const { permissionModalVisible, onAllow, onDeny } = useLaunchLocationPrompt();
  ...
  return (
    <>
      ...
      <PermissionModal
        ...
        description="We use your location to auto-fill your delivery address so checkout is faster. You can always type it manually instead."
